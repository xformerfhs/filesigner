...
func VerifyFileHashes(hashVerifier hashsigner.HashVerifier, fileSignatures map[string]string, fileHashList map[string]*filehashing.HashResult) ([]string, []error) {
	var err error
